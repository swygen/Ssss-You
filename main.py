...
import requests
import asyncio
from keep_alive import keep_alive  # keep_alive ফাইলটিকে ইম্পোর্ট করছি
...
WELCOME_MSG = """স্বাগতম! আপনি এই বট ব্যবহার করে TikTok ভিডিও Watermark ছাড়াই ডাউনলোড করতে পারবেন। নিচের অপশন থেকে একটি বেছে নিন: """

@dp.message_handler(commands=['start'])
async def send_welcome(message: types.Message):
    username = message.from_user.username  # ইউজারের নাম পাওয়া
    keyboard = types.ReplyKeyboardMarkup(resize_keyboard=True)
    keyboard.add("Download Video", "Developer")
    await message.answer(f"স্বাগতম, {username}! {WELCOME_MSG}", reply_markup=keyboard)
...
async def download_tiktok_video(message: types.Message):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # ১ ঘন্টা পর ভিডিও ডিলিট (Bot মেসেজ থেকে)
...
if __name__ == "__main__":
    keep_alive()  # বট সার্ভার চালু রাখতে
